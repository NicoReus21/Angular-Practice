...
Generado automáticamente: 2025-11-25T18:27:16.542Z
...
- [II. Requerimientos](#ii-requerimientos)
  - [Módulo: Correos](#modulo-correos)
  - [Módulo: Material Mayor](#modulo-material-mayor)
  - [Módulo: Proceso Bombero Accidentado](#modulo-proceso-bombero-accidentado)
  - [Módulo: Seguimiento de Accidentes](#modulo-seguimiento-de-accidentes)
...
| Usuario | Descripción |
| --- | --- |
| Administrativo | Pendiente de documentar |
| Capitán | Pendiente de documentar |
| Encargado de Material Mayor | Pendiente de documentar |
| Contabilidad | Pendiente de documentar |
| Inspector | Pendiente de documentar |
| Comandancia | Pendiente de documentar |
| Auditoría | Pendiente de documentar |
| Todos | Pendiente de documentar |
| Inspector de Material Mayor | Pendiente de documentar |
| Encargados de Material Mayor | Pendiente de documentar |
| Dirección | Pendiente de documentar |
| Encargado | Pendiente de documentar |
| Encargado de Compañía | Pendiente de documentar |
| Bombero | Pendiente de documentar |
...
### Módulo: Proceso Bombero Accidentado
...
### Módulo: Seguimiento de Accidentes
